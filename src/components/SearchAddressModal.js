...
export default function SearchAddressModal({isModalVisible, toggleModal, newAddress, setNewAddress, currentPlace}) {
      ...
      <Container>
        ...
        <ModalChildrenView>
          <SearchContainer>
            ...
            />
            <ClearDestinationButton testID="clear-button" onPress={() => setNewAddress('')}>
